...
CREATE INDEX "store_products_shop_id_has_platform_attention_idx"
ON "store_products"("shop_id", "has_platform_attention");

CREATE INDEX "store_products_shop_id_has_blocking_issue_idx"
ON "store_products"("shop_id", "has_blocking_issue");
